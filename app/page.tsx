  ...
  return (
    <main className="hero-glow relative flex min-h-screen flex-1 flex-col items-center justify-center px-6 py-24">
      <div className="flex flex-col items-center text-center">
        <Image
          src="/teleport-icon.svg"
          alt=""
          width={200}
          height={193}
          priority
          className="icon-glow materialize h-42 w-43.5 sm:h-52.5 sm:w-54.25"
        />

        <h1 className="materialize materialize-delay-1 mt-10 text-4xl font-medium tracking-tight text-foreground sm:text-5xl">
          Time Travel API
        </h1>
        <p className="materialize materialize-delay-1 mt-4 max-w-xs text-lg text-muted sm:max-w-sm">
          Holiday-aware date mapping across years.
        </p>
        <p className="materialize materialize-delay-1 mx-auto mt-6 max-w-md text-base leading-relaxed text-muted sm:max-w-lg sm:text-lg">
